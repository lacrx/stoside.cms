...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blocks: Schema.Attribute.DynamicZone<['shared.rich-text', 'shared.visualization']>;
...
export interface ApiWalkAuditWalkAudit extends Struct.CollectionTypeSchema {
  collectionName: 'walk_audits';
  info: {
    displayName: 'Walk Audit';
    pluralName: 'walk-audits';
    singularName: 'walk-audit';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    description: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::walk-audit.walk-audit'> &
      Schema.Attribute.Private;
    mapUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    segments: Schema.Attribute.Component<'walk-audit.segment', true>;
    slug: Schema.Attribute.UID<'title'>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration (social links, etc.) edited by the Strapi admin and consumed by the Gatsby frontend at build time.';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::site-setting.site-setting'> &
      Schema.Attribute.Private;
    meetupUrl: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::walk-audit.walk-audit': ApiWalkAuditWalkAudit;
